...
import { Idioma, IdiomasDAOService, IdiomasViewModelService } from './servicios.service';
import { NO_ERRORS_SCHEMA, Type } from '@angular/core';
import { FormsModule } from '@angular/forms';
import { IDIOMAS_COMPONENTES } from './componente.component';

describe('Modulo Idiomas', () => {
  const apiURL = environment.apiURL + 'idiomas'
  const dataMock = [
  ...
  describe('DAOService', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [IdiomasDAOService, HttpClient],
      });
    });
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [NotificationService, LoggerService,
          {
            provide: IdiomasDAOService, useFactory: () => new DAOServiceMock<Actor, number>([...dataMock])
          }
        ],
      });
