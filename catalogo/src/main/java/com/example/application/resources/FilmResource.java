...
//			@Parameter(allowEmptyValue = true, required = false, schema = @Schema(type = "string", allowableValues = {"details","short"}, defaultValue = "short")) 
	...
	record Search(@Schema(description = "Que el titulo contenga") String title,
			...
			@Schema(description = "Duración máxima de la pelicula", type = "string", allowableValues = { "details",
					"short" }, defaultValue = "short") String mode){
	}
